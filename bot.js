...
// playing
client.on('ready', () => {                           
client.user.setGame(``,'https://www.twitch.tv/master__gamersyt');                                                                                                                                                                                                                                                                                                                                                                                                                             client.user.setGame(`~help | Created By MasterGamers`,'https://www.twitch.tv/master__gamersyt');
});
...
client.on("message", message => {
 if (message.content === "~help") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('======================================================')
	  .addField('~help-public', `For Public Commands`)
	  .addField('~help-admin', `For Admin Commands`)
	  .addField('~help-games', `For Games Commands`)
      .setFooter('======================================================')
 ...
 if (message.content === "~help-public") {
  const embed = new Discord.RichEmbed()
	  ...
	  .addField('~search', `To Search Any Member In The Server `)
	  .addField('~bot', `Servers that use our bot `)
	  .addField('~id', `Your IDentification`)
	  .addField('~mail', `To Mail Any Member `)
 ...
 if (message.content === "~help-games") {
  const embed = new Discord.RichEmbed()
	  ...
	  .addField('~عقاب', `Aekab Game`)
	  .addField('~خواطر', `Khwater Game`)
	  .addField('~حب', `Love Game`)
	  .addField('~كت تويت', `Kit-tweet Game`)
	  .addField('~لو خيروك', `lw khyarok Game`)
      .setFooter('======================================================')
  message.author.send({embed});
  }
});
...
client.on("message", message => {
 if (message.content === "~support") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© LegendsBot :heart: جميع الحقوق محفوظة 2019 لــبوت')
      .addField('سيرفر الدعم الفني', `https://discord.gg/6697WJj`)
  message.author.send({embed});
...
client.on('message', message => {
    ...
    if(message.content.includes('discord.gg')){
		if(!message.channel.guild) return;
        message.delete()
    return message.reply(`** ⛔ | Invites Links Not Allowed In This Server :broken_heart:**`)
    }
});    

client.on('message', msg => {
  if (msg.content === '~help') {
    msg.reply(' شيك عل خاص يا حلو :kissing_heart: ');
  }
});
...
let Embed = new Discord.RichEmbed()
   ...
   client.on('message', message => {
    var prefix = "~";
      ...
      if (message.author.id == 462045883718959104) return;


    if (message.content.startsWith(prefix + 'playing')) {
    if (message.author.id !== '465154085067292673') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
client.on("message", message => {
    ...
    if(message.content.startsWith(prefix + 'روم')) {
     let args = message.content.split(" ").slice(1);
      ...
      message.channel.send(`☑ TemporarySound : \`${nam}\``).then(c => setTimeout(() => c.edit(`<@${message.author.id}> ⏱  انتهى وقت الروم الصوتي`), 120000))  // 
    }
    });
	
const child_process = require("child_process");
const adminprefix = "~";
const devs = ['465154085067292673'];
